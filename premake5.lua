...
workspace("gtech")
    ...
    -- compiler/linker flags
        flags {"FatalWarnings", "NoImportLib", "MultiProcessorCompile", "NoImplicitLink", "NoMinimalRebuild"}
        cppdialect "C++14"
    ...
    -- library/include paths
        filter "configurations:Debug"
            libdirs{"dependencies/libdebug"}
        filter "configurations:Release"
            libdirs{"dependencies/librelease"}
        filter {}
